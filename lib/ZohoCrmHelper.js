...
(function (global) {
    ...
    function _handleEventCallback(data) {
        ...
        try {
            var result = _widgetLocalEventCallbacks[listenerId].call(_eventScope, callbackArg, promiseControl);
        ...
        $: (function () {
            ...
            function _createChannelAPI(channel) {
                var _api = {
                     ...
                     * @param {String} listenerId - The listener ID returned by on()
                     */
    ...
    global.zdk.app = (function() {
        return {
             ...
             * @param {string} listenerId - ID returned by zdk.app.on
             */
            off: function(listenerId) {
                delete _widgetLocalEventCallbacks[listenerId];
                self.parent.postMessage({
